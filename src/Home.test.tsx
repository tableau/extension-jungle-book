...
describe('Adds shapes', () => {
    ...
    // it('Removes the last shape created', () => {
...
describe('Shapes settings get saved', () => {
    ...
    it('Saves shapes to settings', () => {
        ...
        shapes[0].id = '';
        const rectangle = '[{"id":"","type":"rectangle","coords":[10,10],"points":[[30,30]],"dimensions":[20,20],\"radius\":[0,0],"values":[{"field":"AnimalGroup","value":"Lion"}]}]';
